...
exports.postUserLogin=async (req,res,next)=>{
   ...
   let responseLogin=await  SIGNUP.findAll({where:{emailid:requestBody.UEmail}})
   if (responseLogin.length>0){
      if (bcrypt.compare(requestBody.UPassword,responseLogin[0].password,(err,response)=>{
         if(response){
            const token = jswt.sign(responseLogin[0].id,'d4b0f29b1877137109172a1ed62067fa9351a507f7e8e6ffbdde9252df37870137891da68fc8a215f95a91cda7bcd0d342b190487d51457073bb514ede01861b');
